...
CREATE TABLE public.dim_producto (
                ...
                raiting_producto DOUBLE PRECISION NOT NULL,
...
CREATE TABLE public.hecho_popularidad_producto (
                ...
                CONSTRAINT hecho_popularidad_producto_pk PRIMARY KEY (id_hecho_popularidad_producto, id_categoria, id_pais, id_producto, id_variacion, id_moneda, id_tiempo)
);
